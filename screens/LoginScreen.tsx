      ...
      {showFaceID && (
        <div className="absolute inset-0 z-50 bg-white/80 backdrop-blur-xl flex flex-col items-center justify-center animate-fade-in">
          <div className="relative w-32 h-32 mb-8">
            ...
            <div className="absolute bottom-0 right-0 bg-green-500 text-white p-1 rounded-full animate-bounce">
              <Icon name="check" className="text-sm" />
            </div>
          </div>
          <h3 className="text-xl font-bold text-slate-800 mb-2">Verifying Face ID...</h3>
          <p className="text-slate-500 mb-8">Look at the camera</p>

          <Button variant="outline" onClick={() => setShowFaceID(false)}>Cancel</Button>
