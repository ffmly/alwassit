            ...
            {!scanned ? (
                <>
                    ...
                    <div className="absolute inset-0 flex flex-col items-center justify-center">
                        ...
                        <p className="text-white font-mono mt-8 bg-black/50 px-4 py-2 rounded-full backdrop-blur">Align QR Code within frame</p>
                    </div>
                    <button onClick={onBack} className="absolute top-8 left-6 text-white p-2 bg-white/20 backdrop-blur rounded-full"><Icon name="close" /></button>
                </>
            ) : (
                 <div className="flex-1 flex flex-col items-center justify-center p-8 bg-white/10 backdrop-blur-xl animate-pop-in">
                    ...
                    <h3 className="text-2xl font-bold text-white mb-2">Merchant Detected</h3>
                    <p className="text-slate-300 mb-8">Uno Hypermarket - Branch 02</p>
                    <div className="w-full space-y-4">
                        <Button onClick={onBack}>Confirm Payment</Button>
